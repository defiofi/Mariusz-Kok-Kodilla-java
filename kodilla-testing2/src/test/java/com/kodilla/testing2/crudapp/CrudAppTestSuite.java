...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://defiofi.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("kokmar76@gmail.com");		        // [3]
        driverTrello.findElement(By.id("password")).sendKeys("QVgiCKUc4DeqpPq");		    // [4]
